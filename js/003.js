 ...
 * Spread
 * 
 * Чаще всего используется при копировании массива в массив
 * или объкта в объект
 *
 */
...
// чтобы скопировать создаем новый массив
// и просто ...arr внутри []
const arr2 = [...arr1]
// результат: 2 одинаковых массива
console.log(arr2) // log (5) [1, 2, 3, 4, 5]

// - Вносим изменения в новый массив

arr2[2] = 456
// исходный массив не изменился
console.log(arr1) // log (5) [1, 2, 3, 4, 5]
// результат: появилось значение 456
console.log(arr2) // log (5) [1, 2, 456, 4, 5]
...
// чтобы скопировать создаем новый обёект
// и распыляем туда исходный объект
const obj2 = { ...obj1 }
// результат: копия исходного объекта
console.log(obj2) // log {name: "Bobby", age: 15}

// - Вносим изменения в новый объект

// в отличии от массива, в объекте изменения
// вносят по ключу, а не по индексу
obj2.age = 35
...
// - Ищем min и max в массиве
// минимум - 1, максимум - 5

// имеем массив
const numbers = [2, 1, 5, 3, 4]

// исполюзуя Math.min распыляем numbers
const min = Math.min(...numbers) // ищем 1
// результат: минимальное 1
console.log(min) // log 1

// исполюзуя Math.max распыляем numbers
const max = Math.max(...numbers) // ищем 5
// результат: максимальное 5
console.log(max) // log 5

*/
/*

// - Добавляем новые элементы и методы в распыленный массив

// имеем два массива 
const arr0 = ["a", "b", "c", "d", "e"]
const arr1 = [1, 2, 3, 4, 5]

// создаем новый массив, распыляем исходные
// можно применять методы и добавлять другие елементы
const arr2 = [...arr1.slice(0, 3), 6, 7, "word"]

console.log(arr2) // log (6) [1, 2, 3, 6, 7, "word"]

*/
/*

// - Добавляет и изменяет ключи в распыленном массиве

// имеем мас
const obj1 = { name: "Bobby", age: 15 };

// создаем, распыляем, доюавляем новый ключ 
// и изменяем значение существующего ключа
// Распыление всегда идет первым, все что 
// перед ним не отображается
const obj2 = { name: "Poly", ...obj1, eyes: "brown", age: 27};

console.log(obj2) // log {name: "Bobby", age: 27, eyes: "brown"}
...
function fn1(a, b, ...rest) {
  ...
  console.log(rest) // log (7) [2, 3, 4, 5, 6, 7, 8]
}
